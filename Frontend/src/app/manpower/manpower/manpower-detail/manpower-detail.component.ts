...
import { ManpowerDetailBaseComponent } from '@baseapp/manpower/manpower/manpower-detail/manpower-detail.base.component';
import { Component, OnInit } from '@angular/core';
import { DialogService } from 'primeng/dynamicdialog';
import { ConfirmationService, MessageService } from 'primeng/api';
import { ManpowerService } from '@baseapp/manpower/manpower/manpower.service';

@Component({
  selector: 'app-manpower-detail',
  templateUrl: '../../../../../base/app/manpower/manpower/manpower-detail/manpower-detail.component.html',
  styleUrls: ['./manpower-detail.scss']
})
export class ManpowerDetailComponent extends ManpowerDetailBaseComponent implements OnInit {
 
  constructor(public override manpowerService: ManpowerService, public override appUtilBaseService: AppUtilBaseService, public override translateService: TranslateService, public override messageService: MessageService, public override confirmationService: ConfirmationService, public override dialogService: DialogService, public override domSanitizer: DomSanitizer, public override bsModalService: BsModalService, public override activatedRoute: ActivatedRoute, public override appBaseService: AppBaseService, public override router: Router, public override appGlobalService: AppGlobalService, public override location: Location) {
    super(manpowerService, appUtilBaseService, translateService, messageService, confirmationService, dialogService, domSanitizer, bsModalService, activatedRoute, appBaseService, router, appGlobalService, location);
  }
