...
import { ProjectTypeListBaseComponent } from '@baseapp/project-type/project-type/project-type-list/project-type-list.base.component';
...
@Component({
  ...
  templateUrl: '../../../../../base/app/project-type/project-type/project-type-list/project-type-list.component.html',
  styleUrls: ['./project-type-list.scss']
})
export class ProjectTypeListComponent extends ProjectTypeListBaseComponent implements OnInit {
  ...
  constructor(public override projectTypeService: ProjectTypeService, public override appUtilBaseService: AppUtilBaseService, public override translateService: TranslateService, public override messageService: MessageService, public override confirmationService: ConfirmationService, public override dialogService: DialogService, public override domSanitizer: DomSanitizer, public override bsModalService: BsModalService, public override activatedRoute: ActivatedRoute, public override renderer2: Renderer2, public override router: Router) {
    super(projectTypeService, appUtilBaseService, translateService, messageService, confirmationService, dialogService, domSanitizer, bsModalService, activatedRoute, renderer2, router);
  }
