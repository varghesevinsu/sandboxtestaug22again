import { PlaceOfDevService } from '../place-of-dev.service';
...
export class PlaceOfDevListBaseComponent{
...
isRowSelected: boolean = false;
  ...
  "children" : [ {
    ...
    "children" : [ {
      ...
      "type" : "button",
      "pageName" : {
        "name" : "Place of dev Detail",
        "sid" : "74ea49f7-dd05-4f22-8394-fcd5c9bc2496",
        "url" : "/placeofdev/placeofdevdetail"
      },
      "outline" : "true",
  ...
  "children" : [ {
    ...
    "allowedValues" : {
      "values" : [ {
        "label" : "ENTITY1_FROM_ED",
        "value" : "ENTITY1_FROM_ED"
      }, {
        "label" : "ENTITY2_FROM_ED",
        "value" : "ENTITY2_FROM_ED"
      }, {
        "label" : "ENTITY3_FROM_ED",
        "value" : "ENTITY3_FROM_ED"
      }, {
        "label" : "PLEASE_SELECT",
        "value" : "PLEASE_SELECT"
      } ],
    ...
    "allowedValues" : {
      "values" : [ {
        "label" : "LOCATION1_FROM_ED",
        "value" : "LOCATION1_FROM_ED"
      }, {
        "label" : "LOCATION2_FROM_ED",
        "value" : "LOCATION2_FROM_ED"
      }, {
        "label" : "LOCATION3_FROM_ED",
        "value" : "LOCATION3_FROM_ED"
      }, {
        "label" : "PLEASE_SELECT",
        "value" : "PLEASE_SELECT"
      } ],
    ...
    "allowedValues" : {
      "values" : [ {
        ...
        "label" : "SITE_3_FROM_ED",
        "value" : "SITE_3_FROM_ED"
      }, {
        "label" : "PLEASE_SELECT",
        "value" : "PLEASE_SELECT"
      } ],
  ...
  "detailPageNavigation" : "click_of_the_row"
	...
	pageViewTitle: string = 'PLACE_OF_DEV_LIST';
...
this.messageService.add(config);
    ...
    let action: Exclude<keyof PlaceOfDevListBaseComponent, ' '> = methodName;
...
this.onRefresh();
	...
	this.placeOfDevService.getDatatableDataByPId(params).subscribe((data: any) => {
		let updateRecords: PlaceOfDevBase[] = [...this.gridData, ...data?.results];
...
onUpdateChild(id: any) {
 ...
 onNewChild() {
 	this.router.navigateByUrl('/placeofdev/placeofdevdetail' + '?pid=' + this.parentId)
 }
	onRefresh(){
this.gridData = [];
this.params.start =0;
this.loadGridData();
  ...
  if (this.selectedValues.length > 0) {
	...
	const requestedParams = {ids:values.toString()}
      this.confirmationService.confirm({
        ...
        accept: () => {
          this.placeOfDevService.delete(requestedParams).subscribe((res: any) => {
 ...
 this.onRefresh();
  ...
  if (environment.prototype) {
  	gridSubscription = this.placeOfDevService.getProtoTypingData().subscribe((data: any) => {
	  	...
	  	let property: Exclude<keyof PlaceOfDevListBaseComponent, ''> = value;
	  	const method:any = "getChildTableData";
	  	let action: Exclude<keyof PlaceOfDevListBaseComponent, ''> = method;
	  	if(this.isChildPage && this[property] && typeof this[action] === "function"){
	  		params.pid = this[property];
	  		this[action](params);
	  	}
	  	else{
		  	this.placeOfDevService.getDatatableData(params).subscribe((data: any) => {
				let updateRecords: PlaceOfDevBase[] = [...this.gridData, ...data?.results];
				const ids = updateRecords.map(o => o.sid)
				this.gridData = updateRecords.filter(({ sid }, index) => !ids.includes(sid, index + 1))
				this.total = data?.filtered ? data?.filtered : 0;
	...
	if (this.isChildPage && this[property]) {
		...
		this.router.navigate(['../placeofdevdetail'], { relativeTo: this.activatedRoute});
	}
}
