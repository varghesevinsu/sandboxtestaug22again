...
export class UserGuideDetailBaseComponent{
...
workflowActions:any ={
  ...
  "type" : "form"
	...
	pageViewTitle: string = 'USER_GUIDE_DETAIL';
 ...
 onChangelog() {
	...
	onSave(isToastNotNeeded?:boolean){
        ...
        if(!this.appUtilBaseService.isValidForm(this.detailFormControls, this.formErrors, finalArr, this.inValidFields)){
            ...
            this.messageService.clear();
            this.userGuideService[method](requestedObj).subscribe((res:UserGuideBase) => {
	...
	getData(){
        ...
        const params = {
          sid: this.id
            ...
            this.userGuideService.getProtoTypingDataById(params).subscribe((res:any) =>{
                this.data = res;
                this.backupData = res;
                this.detailFormControls.patchValue(this.backupData);
            });
            ...
            this.userGuideService.getById(params).subscribe((res:UserGuideBase[]) =>{
                this.data = res||{};
                this.backupData = res || {};
    ...
    let action: Exclude<keyof UserGuideDetailBaseComponent, ' '> = methodName;
    const finalArr: string[] = [];
    this.formErrors = {};
    this.inValidFields = {};
