...
workflowActions:any ={
  ...
  "type" : "form"
	...
	pageViewTitle: string = 'PROJECT_TYPE_DETAIL';
  ...
  createAutoSuggestFields(ele: any) {
    ...
    let action: Exclude<keyof ProjectTypeDetailBaseComponent, ' '> = methodName;
	...
	getData(){
        ...
        const params = {
          sid: this.id
            ...
            this.projectTypeService.getProtoTypingDataById(params).subscribe((res:any) =>{
                this.data = res;
                this.backupData = res;
                this.detailFormControls.patchValue(this.backupData);
            });
            ...
            this.projectTypeService.getById(params).subscribe((res:ProjectTypeBase[]) =>{
                this.data = res||{};
                this.backupData = res || {};
