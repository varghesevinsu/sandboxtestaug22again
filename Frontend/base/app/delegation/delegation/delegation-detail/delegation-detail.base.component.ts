...
export class DelegationDetailBaseComponent{
...
isRowSelected:boolean = true; 
  ...
  "type" : "form"
	...
	pageViewTitle: string = 'DELEGATION_DETAIL';
  ...
  createAutoSuggestFields(ele: any) {
    ...
    let action: Exclude<keyof DelegationDetailBaseComponent, ' '> = methodName;
...
addValidations(mandatoryFields:[]){
	...
	getDateTimeFields() {
    return ['modifiedDate','createdDate','delegationEndDate','delegationStartDate'];
  }
