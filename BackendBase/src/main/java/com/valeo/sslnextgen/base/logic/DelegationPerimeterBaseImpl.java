...
public abstract class DelegationPerimeterBaseImpl<T extends DelegationBase> implements IPerimeterManager<T> {
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase.isDevAdmin()) {
			...
			String[] readFields = new String[] {"delegationEndDate","modifiedBy","createdBy","approverLeader","modifiedDate","delegateName","test2","sid","createdDate","delegationStartDate"};
