...
public abstract class ProjectTypePerimeterBaseImpl<T extends ProjectTypeBase> implements IPerimeterManager<T> {
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase.isDevAdmin()) {
			...
			String[] readFields = new String[] {"projectType","createdDate","modifiedDate","sid","status","modifiedBy","dummyTest","createdBy"};
