...
public class ManPowerBLBaseImpl<T extends ManPowerBase> extends BaseBusinessLogic<T>
		implements IManPowerBLBase<T> {
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogBL.createChangeLog("ManPower", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogBL.createChangeLog("ManPower", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogBL.createChangeLog("ManPower", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
