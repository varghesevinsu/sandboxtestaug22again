...
public class ProjectTypeBLBaseImpl<T extends ProjectTypeBase> extends BaseBusinessLogic<T>
		implements IProjectTypeBLBase<T> {
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogBL.createChangeLog("ProjectType", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogBL.createChangeLog("ProjectType", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogBL.createChangeLog("ProjectType", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
	...
	public T getByProjectType(String projectType) {
		...
		filters.add(new SimpleFilter("projectType", projectType, Operator.EQUAL));
