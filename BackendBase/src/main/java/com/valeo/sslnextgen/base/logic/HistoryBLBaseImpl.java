...
public class HistoryBLBaseImpl<T extends HistoryBase> extends BaseBusinessLogic<T>
		implements IHistoryBLBase<T> {
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogBL.createChangeLog("History", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogBL.createChangeLog("History", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogBL.createChangeLog("History", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
