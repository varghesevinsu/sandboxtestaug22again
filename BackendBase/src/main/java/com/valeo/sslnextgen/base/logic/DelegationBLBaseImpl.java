...
import com.valeo.sslnextgen.base.model.DelegationBase;
import com.valeo.sslnextgen.base.logic.IDelegationBLBase;

import java.util.List;


public class DelegationBLBaseImpl<T extends DelegationBase> extends BaseBusinessLogic<T>
		implements IDelegationBLBase<T> {
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogBL.createChangeLog("Delegation", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogBL.createChangeLog("Delegation", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogBL.createChangeLog("Delegation", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
