...
import com.valeo.sslnextgen.base.logic.IToolBLBase;
...
public class ToolBLBaseImpl<T extends ToolBase> extends BaseBusinessLogic<T>
		implements IToolBLBase<T> {
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogBL.createChangeLog("Tool", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogBL.createChangeLog("Tool", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogBL.createChangeLog("Tool", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
	...
	public T getByTool(String tool) {
		...
		filters.add(new SimpleFilter("tool", tool, Operator.EQUAL));
