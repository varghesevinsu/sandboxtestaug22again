...
public abstract class ManPowerPerimeterBaseImpl<T extends ManPowerBase> implements IPerimeterManager<T> {
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase.isDevAdmin()) {
			...
			String[] readFields = new String[] {"sid","dummyTest","service","modifiedDate","modifiedBy","test2","createdDate","createdBy","metier","currency","rate","site"};
