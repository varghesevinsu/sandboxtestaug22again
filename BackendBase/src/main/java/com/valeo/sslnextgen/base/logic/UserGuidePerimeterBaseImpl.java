...
public abstract class UserGuidePerimeterBaseImpl<T extends UserGuideBase> implements IPerimeterManager<T> {
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase.isDevAdmin()) {
			...
			String[] readFields = new String[] {"sid","modifiedDate","link","description","modifiedBy","dummyTest","createdDate","createdBy"};
