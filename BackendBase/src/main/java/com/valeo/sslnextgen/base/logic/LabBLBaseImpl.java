...
import com.valeo.sslnextgen.base.logic.ILabBLBase;
...
public class LabBLBaseImpl<T extends LabBase> extends BaseBusinessLogic<T>
		implements ILabBLBase<T> {
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogBL.createChangeLog("Lab", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogBL.createChangeLog("Lab", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogBL.createChangeLog("Lab", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
	...
	public T getByLabName(String labName) {
		...
		filters.add(new SimpleFilter("labName", labName, Operator.EQUAL));
