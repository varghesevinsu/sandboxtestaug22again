...
public class ToolDesignTypeBLBaseImpl<T extends ToolDesignTypeBase> extends BaseBusinessLogic<T>
		implements IToolDesignTypeBLBase<T> {
		
	private ChangelogBLBaseImpl changelogBL;
	
	public ToolDesignTypeBLBaseImpl(Class<T> modelClass) {
		super(modelClass);
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogBL.createChangeLog("ToolDesignType", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogBL.createChangeLog("ToolDesignType", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogBL.createChangeLog("ToolDesignType", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
	...
	public T getByToolDesignType(String toolDesignType) {
		...
		filters.add(new SimpleFilter("toolDesignType", toolDesignType, Operator.EQUAL));
