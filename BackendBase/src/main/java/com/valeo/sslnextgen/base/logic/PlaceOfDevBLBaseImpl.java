...
public class PlaceOfDevBLBaseImpl<T extends PlaceOfDevBase> extends BaseBusinessLogic<T>
		implements IPlaceOfDevBLBase<T> {
	...
	public void onAfterSaveDB(T modelObj) {
	  changelogBL.createChangeLog("PlaceOfDev", modelObj.getSid(), Constants.SAVED, modelObj);
	}
	...
	public void onAfterUpdateDB(T modelObj) {
	  changelogBL.createChangeLog("PlaceOfDev", modelObj.getSid(), Constants.UPDATED, modelObj);
	}
	...
	public void onAfterDeleteDB(T modelObj) {
	  changelogBL.createChangeLog("PlaceOfDev", modelObj.getSid(), Constants.DELETED, modelObj);
	}	
	...
	public T getBySiteCode(String siteCode) {
		...
		filters.add(new SimpleFilter("siteCode", siteCode, Operator.EQUAL));
