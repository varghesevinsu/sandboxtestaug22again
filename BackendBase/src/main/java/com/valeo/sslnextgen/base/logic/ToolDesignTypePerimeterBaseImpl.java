...
public abstract class ToolDesignTypePerimeterBaseImpl<T extends ToolDesignTypeBase> implements IPerimeterManager<T> {
	...
	protected void setReadFields(ApplicationUserBase userBase, AllowedFields allowedFields) {
		...
		if(userBase.isDevAdmin()) {
			...
			String[] readFields = new String[] {"createdBy","sid","enabled","modifiedDate","toolDesignType","modifiedBy","dummyTest","createdDate"};
